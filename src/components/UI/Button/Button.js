...
const Button = props => {
	return (
		// Instead of applying a string className we refer to the dynamic - "styles object" in importing from the css file and refer the styles to the button property
